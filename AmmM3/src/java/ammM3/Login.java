...
import ammM3.classi.UtentiFactory;
import ammM3.classi.Utente;
import ammM3.classi.Venditore;
        ...
        if(request.getParameter("Submit") != null)
        {
            ...
            for(Utente u : listaUtenti)
            {
                   ...
                   u.getPassword().equals(password))
                {
                    ...
                    {
                        request.setAttribute("cliente", u.getId());
                ...
                {
                    request.getRequestDispatcher("errorAutentication.jsp").forward(request, response);
                }
            }
        }
