<%-- 
    ...
    Created on : 19-mag-2016, 14.51.22
    Author     : andrea
--%>
            ...
            <header>
                ...
                <div id="header">
                    ...
                    <div class="navigation">
                        <nav> 
                            <ul>
                                <c:if test="${empty compratoreLoggato && empty venditoreLoggato}">
                                    <a href="login.html"> Login</a>
                                </c:if>
                                <c:if test="${not empty compratoreLoggato || not empty venditoreLoggato}">
